...
export const PERSISTENT_REFRESH_TOKEN_SUFFIX = "_refreshToken_persist";
...
export const getPersistentRefreshTokenKey = (moduleName) =>
  `${String(moduleName || "user").trim() || "user"}${PERSISTENT_REFRESH_TOKEN_SUFFIX}`;
